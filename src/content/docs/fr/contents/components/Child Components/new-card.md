...
<NewCard title="Commencer" icon="rocket">
  Guide de configuration rapide pour faire fonctionner votre site de
  documentation en quelques minutes.
</NewCard>
```
...
<NewCard title="Configuration" icon="setting" size="sm">
...
<NewCard title="API Referentie" icon="document" iconColor="#3b82f6">
