...
```
  Project Studi Notes Contribution
```
...
Afterwards, attach your files to the email.
...
```
  ...
  Intended Subject: Data Strucutres and Algorithms
  Intended Program: BS Computer Science
  Intended Year Level: 2
