...
<Button label="Get Started" link="/getting-started" variant="primary" />
```
...
<Button label="Learn More" link="/docs" variant="secondary" />
```
...
<div style="display: flex; gap: 1rem; flex-wrap: wrap;">
  ...
  <Button label="Documentation" link="/docs" variant="secondary" />
  <Button
    label="GitHub"
    link="https://github.com/your-repo"
    variant="outline"
